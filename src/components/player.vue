<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <audio src="currentSong.url" ref="audio" @canplay="ready" @err="error"
    @timeupdate="updataTime" @ended="end"></audio>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    leave(el, done) {
      // this.$refs.cdWarpper.style.transtion='all 0.4s';
      // const {x,y,scale} =this._getPosAndScale();
    ...
    afterLeave() {
      // this.$refs.cdWarpper.style.transtion='';
